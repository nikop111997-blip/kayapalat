...
// Replace these with the actual paths to your WhatsApp screenshot images
...
export default function WhatsAppTestimonials() {
  return (
    <section 
      className="relative w-full min-h-screen bg-fixed bg-center bg-cover bg-no-repeat scroll-smooth"
      // Replace this URL with your actual background image
      style={{ backgroundImage: "url('/kayapalatbg.jpg')" }}
    >
      {/* Glassmorphism Dark Overlay - Ensures the background doesn't overpower the screenshots */}
      <div className="absolute inset-0 bg-white/90 "></div>

      {/* Main Content Container */}
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-24 sm:py-36">
