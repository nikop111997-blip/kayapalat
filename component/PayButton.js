...
export default function PaymentButton({
  ...
  const [mounted, setMounted] = useState(false); // Added for safe Portaling in Next.js
    ...
    <>
      ...
      {variant === "plans" ? (
        ...
        <motion.button
          ...
          className={`${
            variant === "primary"
              ? "bg-[#003460] hover:bg-[#002a4d] text-white"
              : "bg-[#ffce00] hover:bg-[#e6b800] text-[#003460]"
          } justify-center flex items-center gap-2 px-8 py-3.5 rounded-full font-medium shadow-md transition-colors`}
        >
          ...
          <AnimatePresence>
            {open && (
              <motion.div
                ...
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                className="fixed inset-0 bg-black/20 backdrop-blur-sm z-[9999] flex items-center justify-center p-4 sm:p-6"
                onClick={handleClose}
              >
                <motion.div
                ...
                >
                  ...
                  <p className="text-sm text-gray-500 text-center mb-8 px-4 leading-relaxed">
                    Complete your details below to finalize the payment for{" "}
                    {purpose}.
                  </p>
                  ...
                  <div className="space-y-3.5 mb-6">
                    <div>
                      <div className="relative flex items-center">
                        <svg
                          className="w-5 h-5 text-gray-400 absolute left-3.5 pointer-events-none"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                        >
                    ...
                    <div>
                      <div className="relative flex items-center">
                        <User2
                          size={16}
                          className="text-gray-400 absolute left-3.5 pointer-events-none"
                        />
                        <input
                          type="text"
