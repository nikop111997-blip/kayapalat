...
export default function Hero({ openCartWithBundle }) {
  return (
    <section className="px-6 pt-32 pb-12 max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 lg:gap-16 items-center min-h-[90vh]">
  <div className="space-y-8 relative z-10">
    ...
    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 pt-4">
      <button
        ...
        className="group bg-[#1a1a1a] hover:bg-[#003460] w-full sm:w-auto text-white px-8 py-2 rounded-lg font-medium text-lg flex items-center gap-2 transition-all shadow-xl hover:shadow-[#003460]/30 hover:-translate-y-1 justify-between sm:justify-start"
      >
        Buy the Journal 
    ...
    {/* FIX: Changed gap-6 to gap-4 sm:gap-6 for better mobile fit */}
    <div className="grid grid-cols-2 sm:grid-cols-2 items-start sm:items-center gap-4 sm:gap-6 pt-8 text-sm sm:text-md font-medium text-gray-800 border-t border-gray-200">
      <span className="flex items-center gap-2"><Star className="w-4 h-4 text-[#003460] shrink-0" />10,000+ copies sold</span>
      <span className="flex items-center gap-2"><Shield className="w-4 h-4 text-[#003460] shrink-0" /> Premium Hardcover</span>
      <span className="flex items-center gap-2"><Award className="w-4 h-4 text-[#003460] shrink-0" /> Real Life Results</span>
      <span className="flex items-center gap-2"><Truck className="w-4 h-4 text-[#003460] shrink-0" /> Free Shipping</span>
    </div>
  </div>
